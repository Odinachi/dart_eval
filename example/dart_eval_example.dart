...
void main(List<String> args) {
  ...
  // Create a compiler, and add our plugin.
  final compiler = Compiler();
  compiler.addPlugin(ExamplePlugin());
...
/// This code is generated by the bindgen tool. I've annotated it here
/// for clarity, but generally you would not modify this code directly.
...
/// bridge classes and functions with the compiler and runtime.
class ExamplePlugin implements EvalPlugin {
  @override
  String get identifier => 'package:example';

  @override
  void configureForCompile(BridgeDeclarationRegistry registry) {
    registry.defineBridgeClass($TimestampedTime.$declaration);
    registry.defineBridgeClass($WorldTimeTracker$bridge.$declaration);
  }
